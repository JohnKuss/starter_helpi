...
export async function fetchCareerAdvice(
    ...
    const messages = [
        { 
            ...
            Label the first paragraph with Career 1:, second with Career 2:, and third with Career 3:. Make sure there is a period after the career name in the label. 
            ...
            Please separate each paragraph with a double newline (two line breaks) to ensure clear separation between them, after the wikipedia link.` 
        },
        { 
            role: "user", 
